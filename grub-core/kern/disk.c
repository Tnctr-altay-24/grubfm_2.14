...
static void
memdisk_close (grub_disk_t disk __attribute__ ((unused)))
{
}

static grub_err_t
memdisk_read (grub_disk_t disk __attribute__ ((unused)),
...
static grub_err_t
memdisk_write (grub_disk_t disk __attribute__ ((unused)),
