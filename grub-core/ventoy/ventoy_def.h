...
typedef struct wim_resource_header wim_resource_header;
typedef struct ventoy_wim_header wim_header;
typedef struct wim_hash wim_hash;
typedef struct wim_lookup_entry wim_lookup_entry;
typedef struct wim_directory_entry wim_directory_entry;
typedef struct wim_stream_entry
{
    grub_uint64_t len;
    grub_uint64_t unused1;
...
typedef struct ventoy_windows_patch
{
    ...
    struct ventoy_windows_patch *next;
}ventoy_windows_patch;
